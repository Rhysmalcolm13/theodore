...
export class OpenRouterHandler implements ApiHandler, SingleCompletionHandler {
	...
	constructor(options: ApiHandlerOptions) {
		...
		this.client = new OpenAI({
			...
			defaultHeaders: {
				"HTTP-Referer": "https://github.com/Rhysmalcolm13/Theodore", // Optional, for including your app on openrouter.ai rankings.
				"X-Title": "Theodore", // Optional. Shows in rankings on openrouter.ai.
			},
		})
	}
