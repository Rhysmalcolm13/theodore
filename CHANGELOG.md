...
-   Incorporate Premshay's [PR](https://github.com/Rhysmalcolm13/Theodore/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
-   Incorporate dbasclpy's [PR](https://github.com/Rhysmalcolm13/Theodore/pull/54) to add support for gemini-exp-1206
...
-   Fix https://github.com/Rhysmalcolm13/Theodore/issues/50 where sound effects were not respecting settings
...
-   Incorporate lloydchang's [PR](https://github.com/Rhysmalcolm13/Theodore/pull/42) to add support for OpenRouter compression
...
-   Theodore now allows configuration of which commands are allowed without approval!
...
-   Theodore now runs in all VSCode-compatible editors
...
-   Theodore now can run side-by-side with Cline

## [2.1.3]

-   Theodore now allows browser actions without approval when `alwaysAllowBrowser` is true
