			...
			<div
				...
				<div style={{ marginBottom: 5 }}>
					<div style={{ marginBottom: 15 }}>
						...
						<p style={{
							...
							Select the language that Theodore should use for communication.
						</p>
					</div>
				...
				<div
					...
					<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
						...
						<VSCodeLink href="https://github.com/Rhysmalcolm13/Theodore" style={{ display: "inline" }}>
							https://github.com/Rhysmalcolm13/Theodore
						</VSCodeLink>
					</p>
